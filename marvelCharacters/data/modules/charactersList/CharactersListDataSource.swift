...
class CharactersListDataSource: CharactersListDataSourceProtocol {
    
    private var manager: DataSource
    ...
    func getCharacters(with identifier: Int?, parameters: [String: String]?, success: @escaping CharactersResponseBlock, failure: @escaping FailureCompletionBlock) {
        ...
        manager.executeRequest(from: .characters, identifier: identifier, parameters: parameters, success: { response in
